...
**     Date/Time   : 2015-04-30, 13:04, # CodeGen: 70
**     Abstract    :
...
*/         
/*!
**  @addtogroup TFC_INTE_module TFC_INTE module documentation
**  @{
*/         
...
/*
** ===================================================================
**     Method      :  TFC_INTE_OnInterrupt (component TimerInt)
**
**     Description :
...
void TimerIntLdd1_OnInterrupt(LDD_TUserData *UserDataPtr)
{
  ...
  TFC_INTE_OnInterrupt();              /* Invoke OnInterrupt event */
}

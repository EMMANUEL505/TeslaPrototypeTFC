...
**          Wait for result                                : yes
**     Contents    :
**         Measure        - byte TFC_ADCI_Measure(bool WaitForResult);
**         MeasureChan    - byte TFC_ADCI_MeasureChan(bool WaitForResult, byte Channel);
**         GetChanValue   - byte TFC_ADCI_GetChanValue(byte Channel, void* Value);
**         GetValue16     - byte TFC_ADCI_GetValue16(word *Values);
**         GetChanValue16 - byte TFC_ADCI_GetChanValue16(byte Channel, word *Value);
**         Calibrate      - byte TFC_ADCI_Calibrate(bool WaitForResult);
**
...
*/         
/*!
**  @addtogroup TFC_ADCI_module TFC_ADCI module documentation
**  @{
*/         
...
static LDD_ADC_TSample SampleGroup[TFC_ADCI_SAMPLE_GROUP_SIZE];
...
volatile word TFC_ADCI_OutV[TFC_ADCI_SAMPLE_GROUP_SIZE]; /* Sum of measured values */
...
{
  TFC_ADCI_OutV[0] = 0U;               /* Set variable for storing measured values to 0 */
  TFC_ADCI_OutV[1] = 0U;               /* Set variable for storing measured values to 0 */
  TFC_ADCI_OutV[2] = 0U;               /* Set variable for storing measured values to 0 */
  TFC_ADCI_OutV[3] = 0U;               /* Set variable for storing measured values to 0 */
}

/*
** ===================================================================
**     Method      :  TFC_ADCI_HWEnDi (component ADC)
**
**     Description :
...
void TFC_ADCI_HWEnDi(void)
{
  if (ModeFlg) {                       /* Start or stop measurement? */
    if (ModeFlg != SINGLE) {
      ...
      TFC_ADCI_OutV[SumChan] = 0U;     /* Set variable for storing measured values to 0 */
...
/*
** ===================================================================
**     Method      :  TFC_ADCI_Measure (component ADC)
**     Description :
...
** ===================================================================
*/
byte TFC_ADCI_Measure(bool WaitForResult)
{
  if (ModeFlg != STOP) {               /* Is the device in different mode than "stop"? */
    return ERR_BUSY;                   /* If yes then error */
  }
  ModeFlg = MEASURE;                   /* Set state of device to the measure mode */
  TFC_ADCI_HWEnDi();                   /* Enable the device */
...
/*
** ===================================================================
**     Method      :  TFC_ADCI_MeasureChan (component ADC)
**     Description :
...
byte TFC_ADCI_MeasureChan(bool WaitForResult, byte Channel)
...
/*
** ===================================================================
**     Method      :  TFC_ADCI_GetChanValue (component ADC)
**     Description :
...
/*
The definition of method:
byte TFC_ADCI_GetChanValue(byte Channel, void* Value)
was optimised based on the current component setting. An appropriate macro has been defined 
in the AD1.h to maintain API compatibility.
*/
byte TFC_ADCI_GetChanValue(byte Channel, void* Value)
{
  ...
  *(AdcLdd1_TResultData *)Value = TFC_ADCI_OutV[Channel];
  return ERR_OK;
}

/*
** ===================================================================
**     Method      :  TFC_ADCI_GetValue16 (component ADC)
**     Description :
...
** ===================================================================
*/
byte TFC_ADCI_GetValue16(word *Values)
{
  if (OutFlg != 0x0FU) {               /* Is output flag set? */
    return ERR_NOTAVAIL;               /* If no then error */
  }
  Values[0] = TFC_ADCI_OutV[0];        /* Save measured values to the output buffer */
  Values[1] = TFC_ADCI_OutV[1];        /* Save measured values to the output buffer */
  Values[2] = TFC_ADCI_OutV[2];        /* Save measured values to the output buffer */
  Values[3] = TFC_ADCI_OutV[3];        /* Save measured values to the output buffer */
  return ERR_OK;                       /* OK */
}

/*
** ===================================================================
**     Method      :  TFC_ADCI_GetChanValue16 (component ADC)
**     Description :
...
** ===================================================================
*/
byte TFC_ADCI_GetChanValue16(byte Channel, word *Value)
{
  if (Channel >= 4U) {                 /* Is channel number greater than or equal to 4 */
    return ERR_RANGE;                  /* If yes then error */
  }
  ...
  *Value = TFC_ADCI_OutV[Channel];     /* Save measured values to the output buffer */
  return ERR_OK;                       /* OK */
}

/*
** ===================================================================
**     Method      :  TFC_ADCI_Calibrate (component ADC)
**     Description :
...
** ===================================================================
*/
byte TFC_ADCI_Calibrate(bool WaitForResult)
{
  if (ModeFlg != STOP) {               /* Is the device in different mode than "stop"? */
    return ERR_BUSY;                   /* If yes then error */
  }
...
/*
** ===================================================================
**     Method      :  TFC_ADCI_OnMeasurementComplete (component ADC)
**
**     Description :
...
void AdcLdd1_OnMeasurementComplete(LDD_TUserData *UserDataPtr)
{
  ...
  if (ModeFlg == CALIBRATING) {        /* If the driver is in CALIBRATING mode */
    ...
    ModeFlg = STOP;                    /* Set the device to the stop mode */
    TFC_ADCI_OnCalibrationEnd();       /* If yes then invoke user event */
    return;                            /* Return from interrupt */
  }
  if (ModeFlg != SINGLE) {
    AdcLdd1_GetMeasuredValues(AdcLdd1_DeviceDataPtr, (LDD_TData *)&TFC_ADCI_OutV[SumChan]);
    ...
    if (SumChan == 4U) {               /* Is number of measured channels equal to the number of channels used in the component? */
      ...
      TFC_ADCI_OnEnd();                /* If yes then invoke user event */
      ModeFlg = STOP;                  /* Set the device to the stop mode */
      return;                          /* Return from interrupt */
    }
...
/*
** ===================================================================
**     Method      :  TFC_ADCI_Init (component ADC)
**
**     Description :

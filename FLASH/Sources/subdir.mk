...
./Sources/TFC_Controller.o \
./Sources/sa_mtb.o \

C_DEPS += \
./Sources/Events.d \
./Sources/ProcessorExpert.d \
./Sources/TFC_Controller.d \
./Sources/sa_mtb.d \
...
Sources/TFC_Controller.o: ../Sources/TFC_Controller.c
	...
	@echo 'Invoking: ARM Ltd Windows GCC C Compiler'
	"$(ARMSourceryDirEnv)/arm-none-eabi-gcc" "$<" @"Sources/TFC_Controller.args" -MMD -MP -MF"$(@:%.o=%.d)" -o"Sources/TFC_Controller.o"
	@echo 'Finished building: $<'
	@echo ' '

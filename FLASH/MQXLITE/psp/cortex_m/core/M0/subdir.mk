...
MQXLITE/psp/cortex_m/core/M0/boot.o: ../MQXLITE/psp/cortex_m/core/M0/boot.S
	...
	"$(ARMSourceryDirEnv)/arm-none-eabi-gcc" "$<" @"MQXLITE/psp/cortex_m/core/M0/boot.args" -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.d)" -o"MQXLITE/psp/cortex_m/core/M0/boot.o"
...
MQXLITE/psp/cortex_m/core/M0/dispatch.o: ../MQXLITE/psp/cortex_m/core/M0/dispatch.S
	...
	@echo 'Invoking: ARM Ltd Windows GCC Assembler'
	"$(ARMSourceryDirEnv)/arm-none-eabi-gcc" "$<" @"MQXLITE/psp/cortex_m/core/M0/dispatch.args" -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.d)" -o"MQXLITE/psp/cortex_m/core/M0/dispatch.o"
	@echo 'Finished building: $<'
	@echo ' '
